...
def reformat_storage(captured_birds_dir, storage_dir, dry_run):
    ...
    for filename in os.listdir(captured_birds_dir):
        if filename.startswith("bird_") and filename.endswith(".jpg"):
            timestamp_str = filename[5:-4]  # Extract timestamp
            try:
...
if __name__ == "__main__":
    ...
    captured_birds_dir = "captured_birds"
    storage_dir = "storage"
    reformat_storage(captured_birds_dir, storage_dir, args.dry)
